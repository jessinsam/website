...
(function ($) {
   ...
   // ========================================
	...
	// Append button
	var $tt_demo_btn = '<a href="https://www.jessinsamphotography.com" class="tt-demo-btn" target="_blank" rel="noopener"><div class="tt-demo-btn-img"><img src="file:///Users/jessinsams/Desktop/JessinSam/Portfolio/Beauty/images/logo-light.png" alt="Download!"></div><div class="tt-demo-btn-text">My<br>Blog</div></a>';
